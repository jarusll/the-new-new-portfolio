...
---
Side-note - Infinity
To keep the focus of this write up on Recursion, we will assume that Infinity is just a function that never produces a value.
```javascript
const infinity = () => {
  return infinity()
}
...
```
- Ayyyy, that's looks exactly like `factorial0`
...
Yes, I recommend you check out [The Little Schemer](https://mitpress.mit.edu/9780262560993/the-little-schemer/)
Thank you Daniel P. Friedman and Matthias Felleisen
