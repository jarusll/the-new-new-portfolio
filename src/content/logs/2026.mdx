...
I was able to boot into 64 bit using [limine](https://codeberg.org/Limine/Limine). My current target is to make a command shell.

# 2026-03-05
I was doing things wrong by using my host compiler(x86_64) to target i386. I fixed it by compiling `i686-gcc`.

The debugging issue at ASM boundary was gdb losing control at bios interrupts, I read it happens because gdb cannot handle segments ie CS:IP and uses $eip. I am going to keep it very simple and set breakpoints right after each interrupt.

[https://youtu.be/IOn6JxW60HQ?t=423&si=3cJVFbDH-BiUonJ9](https://youtu.be/IOn6JxW60HQ?t=423&si=3cJVFbDH-BiUonJ9)

# 2026-03-02
Hello friend, I've been busy. I have a toy kernel up and running, printing 80x25.
I am making a command interface using the IBM PC BIOS.
...
Everything about x86 assembly led me to the [Intel® 64 and IA-32 Architectures Software Developer's Manual](https://www.intel.com/content/www/us/en/developer/articles/technical/intel-sdm.html). Next target is to setup a 16 bit execution environment.

I am reading Agreements.

[Perfect Day - Lou Reed](https://music.youtube.com/watch?v=V0--emrNth8&si=fq2PxoB9q1yKaPrP)
